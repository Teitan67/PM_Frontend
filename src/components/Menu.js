...
import { CloseCompanySession, OpenCycleInventory, OpenCycleInventoryGraph, OpenInventory, OpenKPIGraph, OpenLobby, OpenPurchaseOrder } from '../functions/pagesFunction';
